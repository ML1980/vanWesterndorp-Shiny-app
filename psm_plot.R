...
psm_plot <-  function(output.psm, plot_title, xmeritko, pmcposun, pmeposun, currency) {
  psmplot <- ggplot(data = output.psm$data_vanwestendorp, aes(x = price)) +
    scale_x_continuous(limits = c(0, xmeritko))+
